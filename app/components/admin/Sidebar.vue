...
const navGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'หน้าความน่าเชื่อถือ', icon: 'heroicons:shield-check', to: '/admin/trust-page' },
      { label: 'LG Service Care', icon: 'heroicons:wrench-screwdriver', to: '/admin/service-care' },
