...
useSeoMeta({
  ...
  description: 'ติดต่อ LG Subscribe — โทร 02-057-5757 หรือสแกน QR Line Official จันทร์–อาทิตย์ 09:00–20:00 น.',
})
</script>
    ...
    <section class="border-b border-gray-100 bg-white">
      <div class="index-container py-10 sm:py-14">
        ...
        >
          ...
          <span>จันทร์–อาทิตย์ <strong class="font-semibold text-gray-900">09:00–20:00 น.</strong></span>
        </div>
      </div>
    </section>
      ...
      <div class="grid gap-6 lg:grid-cols-2 lg:gap-8 lg:items-stretch">
        <div class="flex flex-col gap-6">
          <article class="product-storefront-card flex flex-col p-6 sm:p-8">
            ...
            <a
              href="tel:020575757"
              class="mt-6 block rounded-2xl border border-gray-100 bg-gray-50 px-5 py-5 text-center transition hover:border-[#ea1917]/30 hover:bg-white hover:shadow-[0_4px_20px_rgba(234,25,23,0.08)]"
            >
